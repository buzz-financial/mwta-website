...
var Q = {
  ...
  created() {
    if (this.imageSrc = this.conf.lazy ? "" : this.image, this.clone) return this.addClone();
    this.addSlide({
      id: this._.uid,
      image: this.imageSrc,
      ...
      // Allow overriding the global autoplay slide duration.
    });
  },
  mounted() {
...
var ge = { class: "default" };
var ve = ["innerHTML"];
var pe = ["innerHTML"];
function me(e, s, i, l, o, t) {
  const u = resolveComponent("vnodes"), g = resolveComponent("vueper-slide");
      ...
      createBaseVNode("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            e.isReady && t.conf.infinite && t.canSlide && t.lastSlide ? (openBlock(), createBlock(g, {
              key: 0,
            ...
            e.isReady && t.conf.infinite && t.canSlide && t.firstSlide ? (openBlock(), createBlock(g, {
              key: 1,
    ...
    t.slidesCount && t.conf.slideContentOutside === "bottom" ? (openBlock(), createElementBlock("div", {
      ...
      t.currentSlide.contentSlot ? (openBlock(), createBlock(u, {
        ...
        t.currentSlide.title ? (openBlock(), createElementBlock("div", {
          ...
          class: "vueperslide__title",
          innerHTML: t.currentSlide.title
        }, null, 8, ve)) : createCommentVNode("", true),
        t.currentSlide.content ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: "vueperslide__content",
          innerHTML: t.currentSlide.content
...
var Se = {
  ...
  data: () => ({
    ...
    slides: {
      ...
      focus: 0,
      firstVisible: 0
      // The first visible slide on the left. Useful when visibleSlides > 1.
    },
    mouseDown: false,
    mouseOver: false,
    touch: {
  ...
  computed: {
    ...
    gapsCount() {
      ...
      if (!l || e || s || this.multipleSlides1by1 && this.slides.current < this.preferredPosition) return 0;
    ...
    trackInnerStyles() {
      ...
      } else s || (e.transform = `translate3d(${this.transition.currentTranslation}%, 0, 0)`, e.willChange = this.touch.dragging || this.transition.animated ? "transform" : "auto");
      return e;
    },
    bulletIndexes() {
  ...
  methods: {
    ...
    getSlideshowOffsetTop(e = false) {
      if (this.parallaxData.slideshowOffsetTop === null || e) {
        ...
        for (; s = s.offsetParent; ) i += s.offsetTop;
    ...
    onScroll() {
      ...
      const l = window.innerHeight || s.clientHeight || document.body.clientHeight, o = this.container.clientHeight, t = this.getSlideshowOffsetTop(), u = t + o - i, g = l + i - t;
      if (this.parallaxData.isVisible = u > 0 && g > 0, this.parallaxData.isVisible) {
    ...
    onMouseUp(e) {
      if (this.mouseDown = false, this.touch.dragging) this.conf.autoplay && (!("ontouchstart" in window) && !this.mouseOver ? this.isPaused = false : this.conf.pauseOnTouch || (this.isPaused = false));
      else return this.cancelSlideChange();
      ...
      ].includes(true)) this.cancelSlideChange();
      else {
        const g = this.slides.current + this.conf.slideMultiple * (t ? 1 : -1);
        this.emit(t ? "next" : "previous"), this.goToSlide(g);
      }
    ...
    updateTrackTranslation(e = null) {
      ...
      const { infinite: i, visibleSlides: l, slideMultiple: o, gap: t, "3d": u, lazy: g, lazyLoadOnDrag: c } = this.conf;
      if (i && this.nextSlideIsClone !== false && (s = (this.nextSlideIsClone ? this.slidesCount : -1) / l), t && (s += this.gapsCount / (l / o) * t / 100), this.touch.dragStartX && e && !(i && this.nextSlideIsClone !== false)) {
        ...
        if (a = (h < 0.5 ? 0 : 1) - S, s += a * (this.conf.rtl ? -1 : 1), g && c && !this.touch.lazyloadTriggered) {
          this.touch.lazyloadTriggered = true;
          let p = this.slides.current + (a > 0 ? 1 : -1) * l;
          i && p === -1 ? p = this.slidesCount - 1 : i && p === this.slidesCount && (p = 0);
          for (let C = 0; C < l; C++) {
            const x = this.slides.list[p + C];
            x && !x.loaded && this.loadSlide(x, p + C);
          }
        }
      }
    ...
    goToSlide(e, { animation: s = true, autoPlaying: i = false, jumping: l = false, breakpointChange: o = false, emit: t = true } = {}) {
      ...
      const { nextSlide: u, clone: g } = this.getSlideInRange(e, i);
      if (this.nextSlideIsClone = g, !this.slides.list[u]) return;
      if (this.conf.lazy)
      ...
      if (g !== false && setTimeout(() => {
        const a = e === -1 && this.slides.current !== this.slidesCount - 1, h = e === this.slidesCount && this.slides.current !== 0;
        a || h || (this.transition.speed = 0, this.goToSlide(g ? 0 : this.slidesCount - 1, { animation: false, jumping: true }), setTimeout(() => this.transition.speed = this.conf.transitionSpeed, 50));
